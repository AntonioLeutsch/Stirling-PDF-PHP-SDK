...
class ErrorResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets message
     *
     * @param string|null $message Error message describing what went wrong
     *
     * @return self
     */
     ...
     * Sets timestamp
     *
     * @param string|null $timestamp Timestamp when the error occurred
     *
     * @return self
     */
     ...
     * Sets path
     *
     * @param string|null $path Request path where the error occurred
     *
     * @return self
     */
